...
namespace WeatherTweaks
{
  internal class GameInteraction
  {
    ...
    internal static void SetWeatherEffects(TimeOfDay timeOfDay, List<Definitions.WeatherEffect> weatherEffects)
    {
      ...
      {
        Definitions.WeatherEffect Effect = weather.Effect;
