...
- (Optional) Uncertain weather mechanics: Shown forecast won't always be 100% accurate <br> (Disable `UncertainWeatherEnabled` in the config to disable all.)
  - `Weather?` which has a chance of being a different weather
  - `Weather1/Weather2`: A 50/50 chance for either weather
